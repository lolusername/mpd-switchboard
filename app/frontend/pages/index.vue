  ...
  <div class="min-h-screen bg-[#F5F5F5]">
    ...
    <div class="ml-48 p-8">
      ...
      <div class="grid grid-cols-2 gap-4 mb-8" v-if="stats">
        ...
        <div class="bg-[#2E8B57] rounded-2xl p-5 border border-[#FA7358]/10 hover:shadow-lg transition-all">
          ...
          <div class="grid grid-cols-2 gap-3">
            <div class="bg-[#FFC107] p-3 rounded-xl hover:bg-[#FF6B35]/15 transition-all">
        ...
        <div class="bg-[#FF6F61] rounded-2xl p-5 border border-[#2AB7CA]/10 hover:shadow-lg transition-all">
          <div class="flex items-center gap-2 text-sm font-medium text-[#F5F5F5] mb-3">
            <svg class="w-5 h-5 text-[#F5F5F5]" viewBox="0 0 24 24" fill="#003366">
          ...
          <div class="grid grid-cols-2 gap-3">
            <div class="bg-[#FFC107] p-3 rounded-xl hover:bg-[#2AB7CA]/15 transition-all">
